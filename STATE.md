...
- 434: replenishment — milestone "the small print" (v2.66–v2.67),
  reasoning in LOG.md.
- 435: formatter keeps CRLF — one stroke banked toward v2.66.0.
- Backlog (one per tick, in order): (2) unused local bindings
  warning, io + protocol tests; (3) reference/tutorial/editor README
  sentences — then RELEASE v2.66.0; (4) lib/math.ting trunc,
